    ...
    <section class="about">
      <div class="about-wrap">
        ...
        <div class="about-photo">
          <img src="assest/negroscofee.jpeg" alt="Barista en cafetería" />
        </div>
      </div>
    </section>
      ...
      <div class="mv-wrap">
        <div class="mv-card">
          ...
          <div class="mv-col">
            ...
            <div class="mv-icon">
              <img src="assest/mision.png" alt="Icono pulgar arriba" />
            </div>
          </div>
          ...
          <div class="mv-col">
            ...
            <div class="mv-icon">
              <img src="assest/vision.png" alt="Icono cohete" />
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="features">
      <div class="features-box">
        <div class="feature-item">
          <img src="assest/ícon1.png" alt="Sustainability" />
          <p>Sustainability</p>
        </div>

        <div class="feature-item">
          <img src="assest/icon2.png" alt="No Plastics" />
          <p>No Plastics</p>
        </div>

        <div class="feature-item">
          <img src="assest/icon3.png" alt="Aporta Local" />
          <p>Aporta<br />Local</p>
        </div>

        <div class="feature-item">
          <img src="assest/icon4.png" alt="Local Apoyo" />
          <p>Local<br />Apoyo</p>
        </div>

        <div class="feature-item">
          <img src="assest/icon5.png" alt="Calidad de benas" />
