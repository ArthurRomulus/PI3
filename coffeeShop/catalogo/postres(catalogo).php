...
<body>
  ...
  <footer class="site-footer">
    <div class="footer-container">
      ...
      <div class="footer-actions">
        ...
        <a href="#" id="open-cart" class="icon-btn" aria-label="Carrito" title="Carrito">🛒 <span id="nav-cart-count"></span></a>
  ...
  <section class="hotdrinks" aria-labelledby="hotdrinks-title">
    <div class="hotdrinks__wrap">
      ...
      <!-- GRID DINÁMICA (AJAX) -->
      <!-- Usa el ID 7 de 'Postres' para evitar problemas de acentos -->
      <div class="hotdrinks__grid" data-autoload="ajax" data-categoria="7">
        <p style="grid-column:1/-1; text-align:center; opacity:.7; padding:16px;">Cargando productos…</p>
      </div>
