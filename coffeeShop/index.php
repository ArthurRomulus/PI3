...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="index_sstilo.css">
    <link
...
<!-- Decoración de iconos y líneas arriba de envíos -->
  ...
  <!-- Íconos decorativos laterales -->
  <img
    src="assest/ícon1.png"
    alt="Decoración izquierda"
    class="ts-icon-left"
    style="width:60px;"
  />
  <img
    src="assest/icon2.png"
  ...
  <!-- Iconos sueltos cerca del título -->
  <img
  ...
  <div class="ts-grid">
    ...
    >
      <div class="ts-stage">
        <img
          src="assest/drinks/frappe_clasico.png"
          alt="Frappe Clásico"
        />
    ...
    <article class="ts-card">
      <div class="ts-stage">
        <img
          src="assest/drinks/Frappé caramel.png"
          alt="Frappe Caramel"
        />
  ...
  <div class="catalogo-btn">
    <a href="catalogo.php">
      <span>Catálogo</span>
      <img src="assest/catalogicon.png" alt="Icono Catálogo" />
    </a>
  </div>
</section>
...
<section class="promo" aria-labelledby="promo-title">
  <div class="promo__wrap">
    ...
    <div class="promo__text">
      ...
      <p class="promo__desc">No esperes más para disfrutar el mejor café en grano
        echo en nuestra tienda
      </p>
